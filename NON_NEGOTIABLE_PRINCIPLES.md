# TRINETRA Non-Negotiable Principles

1. **No fabricated results.**
2. **No hard-coded predictions.**
3. **No hard-coded confidence.**
4. **No hard-coded benchmark metrics.**
5. **No hard-coded correlation/coherence claims.**
6. **No silent fallback.**
7. **No test-set tuning.**
8. **No data leakage.**
9. **No train/test preprocessing leakage.**
10. **No claiming coregistration without geometric validation.**
11. **No claiming ground truth without a real reference label.**
12. **No claiming SOTA without protocol-compatible evidence.**
...
20. **Every model checkpoint must be identifiable and hashable.**
...
28. **Cross-dataset performance matters more than one benchmark score.**
29. **Indian/ISRO relevance should supplement, not replace, independent benchmarks.**
30. **When evidence is missing, report “not validated” instead of guessing.**
