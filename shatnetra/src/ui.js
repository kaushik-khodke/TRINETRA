...
/**
 * Central UI orchestrator for TRINETRA — Interactive Remote Sensing Intelligence.
 *
 * Responsibilities:
...
class CockpitViewController {
  constructor(viewer, {
    ...
    if (!this.hud) {
      ...
      this.exit = () => false;
      this.update = () => {};
      this.setContextCollapsed = () => {};
      this.setSignalCollapsed = () => {};
      this.scheduleContextLayout = () => {};
      this.setVisionMode = () => {};
      this.readAircraftInfo = () => null;
...
export class StyleManager {
  ...
  _initGlobalContextPanel() {
    if (!this._globalContextPanel) return;
