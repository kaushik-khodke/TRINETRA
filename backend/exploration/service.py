...
class ExploreService:
    ...
    def _init_default_layers(self) -> None:
        ...
        self._layers["layer-base-satellite"] = ExploreLayer(
            id="layer-base-satellite",
            name="Esri World Satellite (Default)",
            category="base",
            enabled=True,
            ...
            expensive=False,
            opacity=1.0,
            tile_template="https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",
            attribution="Powered by Esri — Source: Esri, Maxar, Earthstar Geographics",
        )
        self._layers["layer-sentinel2-cloudless"] = ExploreLayer(
            id="layer-sentinel2-cloudless",
            name="Sentinel-2 Cloudless (Copernicus 10m)",
            category="imagery",
            enabled=True,
            user_controllable=True,
            ...
            expensive=False,
            opacity=1.0,
            tile_template="https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2021_3857/default/GoogleMapsCompatible/{z}/{y}/{x}.jpg",
            attribution="Copernicus Sentinel-2 / EOX IT Services GmbH",
        )
        self._layers["layer-sentinel1-radar"] = ExploreLayer(
            id="layer-sentinel1-radar",
            name="Sentinel-1 SAR Radar (All-Weather Mosaic)",
            category="imagery",
            enabled=True,
            user_controllable=True,
            ai_controllable=True,
            ...
            expensive=False,
            opacity=1.0,
            tile_template="https://tiles.maps.eox.at/wmts/1.0.0/s1_2020_3857/default/GoogleMapsCompatible/{z}/{y}/{x}.jpg",
            attribution="Copernicus Sentinel-1 / EOX IT Services GmbH",
        )
        self._layers["layer-nasa-viirs"] = ExploreLayer(
            id="layer-nasa-viirs",
            ...
            expensive=False,
            opacity=1.0,
            tile_template="https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_SNPP_CorrectedReflectance_TrueColor/default/default/GoogleMapsCompatible_Level9/{z}/{y}/{x}.jpg",
            attribution="NASA Global Imagery Browse Services (GIBS)",
        )
        self._layers["layer-borders"] = ExploreLayer(
            id="layer-borders",
            name="Political Boundaries & Labels",
            category="system",
            enabled=True,
            user_controllable=True,
            ai_controllable=True,
            ...
            expensive=False,
            opacity=0.8,
            tile_template="https://server.arcgisonline.com/ArcGIS/rest/services/Reference/World_Boundaries_and_Places/MapServer/tile/{z}/{y}/{x}",
            attribution="Esri / Natural Earth",
        )
        self._layers["layer-osm"] = ExploreLayer(
            id="layer-osm",
