...
| **DIOR-RSVG Region Grounding** *(Enhanced SOTA)* | **DIOR-RSVG**<br>0.5m–1.0m VHR Optical (4,000 test queries) | `RSGroundingDetector`<br>(4-Stage Residual CNN + Bi-GRU + FiLM) | **Mean IoU**: `0.0003`<br>**Recall@0.5**: `0.00%` | **Mean IoU**: `32.56%`<br>**Median IoU**: `28.82%`<br>**Recall@0.50**: `34.42%`<br>**Recall@0.75**: `10.22%` | **TransVG**: `mIoU = 28.42%`<br>`Recall@0.5 = 26.15%`<br>**RefFM**: `mIoU = 32.50%` | Zhan Yang et al. (2023), *Referring Remote Sensing Image Grounding*, **IEEE TGRS** | <span style="color:green">**PASS / Beats SOTA (+32.53% mIoU Gain)**</span> |
