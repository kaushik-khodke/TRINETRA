...
export const translations = {
  en: {
    ...
    "upload.accepted": "PNG / JPEG / GeoTIFF · MAX 50MB",
    "upload.drop_prompt": "Drop image or click to browse",
    "upload.formats": "{hint} · PNG, JPEG, GeoTIFF",
  ...
  hi: {
    ...
    "upload.accepted": "PNG / JPEG / GeoTIFF · अधिकतम 50MB",
  ...
  mr: {
    ...
    "upload.accepted": "PNG / JPEG / GeoTIFF · कमाल 50MB",
