        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full h-20 p-2.5 bg-slate-900/90 border border-slate-800 rounded-lg text-xs text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-orange-500/50 resize-none font-sans"
            />
          </div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {EXAMPLE_PROMPTS.map((p) => (
              <button
                ...
                className="px-2 py-0.5 rounded text-[10px] font-mono bg-slate-900 border border-slate-800 text-slate-400 hover:text-orange-300 hover:border-orange-500/30 transition-all flex items-center gap-1"
              >
              ...
              {(["BI_TEMPORAL", "SAR_OPTICAL", "SINGLE_IMAGE"] as AnalysisMode[]).map((m) => (
                <button
                  ...
                  className={`py-1.5 px-2 rounded text-[10px] font-mono font-medium border transition-all text-center ${
                    mode === m
                      ? "bg-orange-950/60 border-orange-500 text-orange-300 shadow-[0_0_10px_rgba(6,182,212,0.2)]"
          ...
          <div className="pt-2 flex items-center gap-2">
            <button
              ...
              className="flex-1 py-2 px-3 bg-gradient-to-r from-orange-600 to-blue-600 hover:from-orange-500 hover:to-blue-500 disabled:from-slate-800 disabled:to-slate-800 disabled:text-slate-600 text-white font-mono text-xs font-semibold rounded-lg shadow-lg shadow-orange-950/50 flex items-center justify-center gap-2 transition-all"
            >
          ...
          {activeTab === "narrative" && (
            <div className="space-y-3 text-xs leading-relaxed text-slate-300 bg-slate-900/50 p-3 rounded-lg border border-slate-800">
              <div className="space-y-1">
                <h4 className="text-[11px] font-mono font-semibold uppercase tracking-wider text-orange-400">
                  Executive Summary
                </h4>
